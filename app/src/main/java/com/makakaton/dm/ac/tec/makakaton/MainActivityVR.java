...
/*
        if (isLookingAtObject1(models1)) {
            ...
            updagObject("0", modelOperation, 0);
       ...
       /* operation = mathLevel2();
        ...
        int whichOpt = random.nextInt(3);
        options[whichOpt]= eval(operation);
    ...
    private void hideObject(String number, int whichModel) {
        ...
        if (whichModel != 0) {
            ...
            if (whichModel == 1) {
                ...
                float angleY = (float) Math.random() * 10.0f + 40.0f; // Angle in Y plane, between -40 and 40.
                ...
                float angleY = (float) Math.random() * 10.0f + 40.0f;  /*(float) 80 - 40*/// Angle in Y plane, between -40 and 40.
                angleY = (float) Math.toRadians(angleY);
                newY = (float) Math.tan(angleY) * objectDistanceOne;
           ...
           /* Toast.makeText(MainActivityVR.this,"x"+String.valueOf(posVec[0]), Toast.LENGTH_SHORT).show();
            ...
            float angleX = (float) Math.random() * 10.0f + 40.0f; // Angle in Y plane, between -40 and 40.
